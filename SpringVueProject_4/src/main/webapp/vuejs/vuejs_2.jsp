...
let app=Vue.createApp({
	data(){
		return{
			box:[{"rank":1,"title":"신과함께-죄와 벌"},{"rank":2,"title":"1987"},{"rank":3,"title":"쥬만지: 새로운 세계"},{"rank":4,"title":"페르디난드"},{"rank":5,"title":"강철비"},{"rank":6,"title":"위대한 쇼맨"},{"rank":7,"title":"원더"},{"rank":8,"title":"극장판 포켓몬스터 너로 정했다!"},{"rank":9,"title":"너의 이름은."},{"rank":10,"title":"뽀로로 극장판 공룡섬 대모험"}]
